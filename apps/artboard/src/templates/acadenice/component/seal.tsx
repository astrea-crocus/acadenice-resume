...
const Seal = ({ src, colorClass, maxHeight }: SealBaseProps) => {
  return (
    <SealContainer maxHeight={maxHeight} className={colorClass}>
      <img src={src} alt="" />
      <Contact />
    </SealContainer>
  );
...
export const SealWhite = (props: SealProps) => (
  <Seal src="logo/light.png" colorClass="text-white" {...props} />
);

export const SealTeal = (props: SealProps) => (
