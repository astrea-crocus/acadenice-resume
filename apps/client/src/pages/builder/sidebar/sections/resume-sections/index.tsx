...
import { SectionIcon as ResumeSectionIcon } from "./sections/shared/section-icon";
...
export const ResumeSections = () => {
  ...
  return (
    <main className="grid h-screen gap-4">
      <div className="flex" role="complementary" aria-label={t`Barre latérale de l'éditeur de CV`}>
        ...
        <ScrollArea orientation="vertical" className="h-screen flex-1 px-6 pb-16 lg:pb-0">
