...
export const SealWhite = (props: SealProps & { id?: string }) => (
  <Seal src={`${import.meta.env.BASE_URL}logo/light.png`} colorClass="text-white" {...props} />
);

export const SealTeal = (props: SealProps & { id?: string }) => (
  <Seal src={`${import.meta.env.BASE_URL}logo/teal.png`} colorClass="text-primary" {...props} />
);
